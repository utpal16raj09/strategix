...
function populateCountryCodes() {
    const countries = [
        ...
        { name: 'IND', code: '62' }, { name: 'IRA', code: '98' },
        { name: 'IRA', code: '964' }, { name: 'IRE', code: '353' },
        { name: 'ISR', code: '972' }, { name: 'ITA', code: '39' },
        { name: 'JAM', code: '1876' }, { name: 'JAP', code: '81' },
        { name: 'JOR', code: '962' }, { name: 'KAZ', code: '7' },
        { name: 'KEN', code: '254' }, { name: 'KIR', code: '686' },
        { name: 'KOR', code: '850' }, { name: 'KOR', code: '82' },
        { name: 'KUW', code: '965' }, { name: 'KYR', code: '996' },
        { name: 'LAO', code: '856' }, { name: 'LAT', code: '371' },
        { name: 'LEB', code: '961' }, { name: 'LES', code: '266' },
        { name: 'LIB', code: '231' }, { name: 'LIB', code: '218' },
        { name: 'LIE', code: '417' }, { name: 'LIT', code: '370' },
        { name: 'LUX', code: '352' }, { name: 'MAC', code: '853' },
        { name: 'MAC', code: '389' }, { name: 'MAD', code: '261' },
        { name: 'MAL', code: '265' }, { name: 'MAL', code: '60' },
        { name: 'MAL', code: '960' }, { name: 'MAL', code: '223' },
        { name: 'MAL', code: '356' }, { name: 'MAR', code: '692' },
        { name: 'MAR', code: '596' }, { name: 'MAU', code: '222' },
        { name: 'MAY', code: '269' }, { name: 'MEX', code: '52' },
        { name: 'MIC', code: '691' }, { name: 'MOL', code: '373' },
        { name: 'MON', code: '377' }, { name: 'MON', code: '976' },
        { name: 'MON', code: '1664' }, { name: 'MOR', code: '212' },
        { name: 'MOZ', code: '258' }, { name: 'MYA', code: '95' },
        { name: 'NAM', code: '264' }, { name: 'NAU', code: '674' },
        { name: 'NEP', code: '977' }, { name: 'NET', code: '31' },
        { name: 'NEW', code: '687' }, { name: 'NEW', code: '64' },
        { name: 'NIC', code: '505' }, { name: 'NIG', code: '227' },
        { name: 'NIG', code: '234' }, { name: 'NIU', code: '683' },
        { name: 'NOR', code: '672' }, { name: 'NOR', code: '670' },
        { name: 'NOR', code: '47' }, { name: 'OMA', code: '968' },
        { name: 'PAL', code: '680' }, { name: 'PAN', code: '507' },
        { name: 'PAP', code: '675' }, { name: 'PAR', code: '595' },
        { name: 'PER', code: '51' }, { name: 'PHI', code: '63' },
        { name: 'POL', code: '48' }, { name: 'POR', code: '351' },
        { name: 'PUE', code: '1787' }, { name: 'QAT', code: '974' },
        { name: 'REU', code: '262' }, { name: 'ROM', code: '40' },
        { name: 'RUS', code: '7' }, { name: 'RWA', code: '250' },
        { name: 'SAN', code: '378' }, { name: 'SAO', code: '239' },
        { name: 'SAU', code: '966' }, { name: 'SEN', code: '221' },
        { name: 'SER', code: '381' }, { name: 'SEY', code: '248' },
        { name: 'SIE', code: '232' }, { name: 'SIN', code: '65' },
        { name: 'SLO', code: '421' }, { name: 'SLO', code: '386' },
        { name: 'SOL', code: '677' }, { name: 'SOM', code: '252' },
        { name: 'SOU', code: '27' }, { name: 'SPA', code: '34' },
        { name: 'SRI', code: '94' }, { name: 'ST.', code: '290' },
        { name: 'ST.', code: '1869' }, { name: 'ST.', code: '1758' },
        { name: 'SUD', code: '249' }, { name: 'SUR', code: '597' },
        { name: 'SWA', code: '268' }, { name: 'SWE', code: '46' },
        { name: 'SWI', code: '41' }, { name: 'SYR', code: '963' },
        { name: 'TAI', code: '886' }, { name: 'TAJ', code: '7' },
        { name: 'THA', code: '66' }, { name: 'TOG', code: '228' },
        { name: 'TON', code: '676' }, { name: 'TRI', code: '1868' },
        { name: 'TUN', code: '216' }, { name: 'TUR', code: '90' },
        { name: 'TUR', code: '993' }, { name: 'TUR', code: '1649' },
        { name: 'TUV', code: '688' }, { name: 'UGA', code: '256' },
        { name: 'UKR', code: '380' }, { name: 'UAE', code: '971' },
        { name: 'URU', code: '598' }, { name: 'UZE', code: '7' },
        { name: 'VAN', code: '678' }, { name: 'VAT', code: '379' },
        { name: 'VEN', code: '58' }, { name: 'VIE', code: '84' },
        { name: 'VIR', code: '1284' }, { name: 'VIR', code: '1340' },
        { name: 'WAL', code: '681' }, { name: 'YEM', code: '967' },
        { name: 'ZAM', code: '260' }, { name: 'ZIM', code: '263' }
    ];

    const optgroup = document.getElementById('all-countries-optgroup');
    if (optgroup) {
